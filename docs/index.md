...
```  
后续我们会使用visio作图辅助  
![](vx_images/19782301401462.png =141x)

这是我们构建的二叉树，让我们看看先序遍历是怎么搜索它的吧！

![](vx_images/111269322682489.png =3914x)
...
![邻接表、](vx_images/226553845520230.png)


![图](vx_images/377825055587420.png)
...
![树状结构](vx_images/28287509719279.png)
